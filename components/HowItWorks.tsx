export default function HowItWorks() {
  return (
    <section style={{ borderTop: '1px solid var(--bg-border-subtle)' }}>
      {/* Stats strip — Stripe backbone style */}
      <div
        style={{
          padding: '80px 0',
                ...
                <div style={{ position: 'relative', height: '180px', overflow: 'hidden' }}>
                  ...
                  <div
                    style={{
                      position: 'absolute',
                      inset: 0,
                      background: `linear-gradient(135deg, ${['rgba(88,81,234,0.7)', 'rgba(124,58,237,0.7)', 'rgba(5,150,105,0.7)'][i]} 0%, transparent 100%)`,
                    }}
                  />
                  <div
                    style={{
                  ...
                  >
                    <span
                      style={{ fontSize: '11px', color: 'rgba(255,255,255,0.85)', fontWeight: 500 }}
                    >
                      {step.detail}
                    </span>
                  </div>
